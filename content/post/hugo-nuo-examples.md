...
date: 2014-07-17
draft: false
slug: hugo-nuo-examples
---

This is a Chinese article for authors who use this theme ([hugo-nuo][hugo-nuo]). Here are some examples about how to use the features of this theme.
...
{{% figure src="./01.jpg" alt="这是一只梅花鹿" title="显然，这是一只梅花鹿" class="zoomable" %}}
